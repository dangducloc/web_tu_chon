         ...
         <div class="row">
            <div class="col-md-6">
               <div class="about_taital_main">
                  ...
                  <p class="about_text">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
         ...
         <div class="">
            <div class="gallery_section_2">
               <div class="row">
                  ...
                  $raw = $con->query("SELECT * FROM drinks");
                           ...
                           <div class="col-md-12">
                              <div class="testimonial_section_2">
                                 ...
                                 <p class="customer_text">many variations of passages of Lorem Ipsum available, but the
                                    ...
                                    have suffered alteration in some embarrassing hidden in the middle of text. All the
                                 </p>
                              </div>
                           </div>
                        </div>
         ...
         <div class="container-fluid">
            <div class="row">
               <div class="col-md-6 padding_0">
                  <form class="mail_section" method="POST" action="send-msg.php">
                     <div class="email_text">
                        <div class="form-group">
                           <textarea class="massage-bt" placeholder="Massage" rows="5" cols="20" id="comment"
                              name="msg"></textarea>
                        </div>
                        <div class="send_btn">
